...
from .serializers import PurchaseAirtimeSerializer
...
def buyairtime(request):
    ...
    response = credit_switch.purchase_airtime("A01E", "100", "08161177351")
    print(response)

    return JsonResponse({"checksum": response}, status=200)
...
class PurchaseAirtimeView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            credit_switch = CreditSwitch("mvend")
